    ...
    app: {
        head: {
            ...
            meta: [
                ...
                {
                    property: "og:title",
                    content: "Stats Studio - Create Beautiful Statistics Cards",
                },
                {
            ...
            link: [
                ...
                {
                    rel: "stylesheet",
                    href: "https://fonts.googleapis.com/css2?family=Kantumruy+Pro:ital,wght@0,100..700;1,100..700&family=Noto+Serif+Khmer:wght@100..900&family=Open+Sans:ital,wght@0,300..800;1,300..800&family=Ubuntu:ital,wght@0,300;0,400;0,500;0,700;1,300;1,400;1,500;1,700&display=swap",
                },
            ],
        },
    },
